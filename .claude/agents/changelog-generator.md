...
1.  **Fetch Diff**:
    ...
    - _Note: If diff content is long, the script may output large amounts of text. Be prepared to read and analyze it._
...
4.  **Commit Changes**:
    ...
    - _Commit message suggestion_: Based on your analysis, write a concise Conventional Commit message (e.g., `feat: add user login feature`).
