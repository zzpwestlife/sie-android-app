...
> _Note: If `Makefile` is missing, check `README.md` for project-specific commands._
...
_GATE: Must pass before technical design._

- [ ] **Simplicity (Art. 1):** Is the standard library used? Is over-abstraction avoided?
- [ ] **Test First (Art. 2):** Does the plan include writing tests _before_ implementation?
...
_If any check fails, provide a strong justification._
```
